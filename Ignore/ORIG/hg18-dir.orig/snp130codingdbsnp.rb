...
# build 130, available from ftp.ncbi.nih.gov/snp. Only SNPs that have a
...
module Bio
  module Ucsc
    module Hg18
      class Snp130CodingDbSnp < DBConnection
        extend Bio::Ucsc::Hg18::QueryUsingChromBin
        set_table_name 'snp130CodingDbSnp'
        set_primary_key nil
       end
    end
  end
