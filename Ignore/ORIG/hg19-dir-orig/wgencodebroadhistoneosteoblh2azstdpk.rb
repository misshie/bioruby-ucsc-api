# -*- coding: utf-8 -*-
# = hg19/wgencodebroadhistoneosteoblh2azstdpk.rb
# Copyright::
...
module Bio
  module Ucsc
    module Hg19
      class WgEncodeBroadHistoneOsteoblH2azStdPk < DBConnection
        extend Bio::Ucsc::Hg19::QueryUsingChromBin
        set_table_name 'wgEncodeBroadHistoneOsteoblH2azStdPk'
        set_primary_key nil
      end 
    end # module Hg19
  end # module Ucsc
