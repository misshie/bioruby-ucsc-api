...
HEADER = "      ## track: EGASP Partial"

TABLES = %w(
encodeEgaspPartAceCons
encodeEgaspPartAceOther
encodeEgaspPartAugustusAbinitio
encodeEgaspPartAugustusEst
encodeEgaspPartAugustusDual
encodeEgaspPartAugustusAny
encodeEgaspPartGenezilla
encodeEgaspPartSaga
)
