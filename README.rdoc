...
* JRuby version 1.6.3 or later - Appropiate Java heap size may be specified to invoke JRuby, especially when you use Bio::Ucsc::Reference. Try "jruby -J-Xmx3g your_script.rb" to keep 3G byte heap.
...
== Change Log
* *NEW* (v.0.2.2): Supporting JRuby 1.6.3 or later. Appropiate Java heap size may be specified to invoke JRuby, especially when you use Bio::Ucsc::Reference. Try "jruby -J-Xmx3g your_script.rb" to keep 3G byte heap.
