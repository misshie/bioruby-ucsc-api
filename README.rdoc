...
== Change Log
* *BUG* (v.0.3.1): "func" fields in tables did not work. The bug was removed.
* *BUG* (v.0.3.1): predGene-type tables without the bin index did not work. The bug was removed.
