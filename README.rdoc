...
* active_record - http://api.rubyonrails.org/classes/ActiveRecord/Base.html (version must be <= 3.0.9)
...
== Change Log
* *BUG* (v.0.3.1): Does not work with ActiveRecord version 3.1.0. Data retrieval methods occur the error, "(Object doesn't support #inspect)". The author is working on this bug. So far, please use version 3.0.9 or earlier. Gemfile for gem dependencies is updated.
