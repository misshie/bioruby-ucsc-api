...
* Automatic conversion of "1-based full-closed intervals" to internal "0-based half-closed interbals" (see also bioruby-genomic-interval)
...
License:: Ruby licence (Ryby's / GPLv2 dual). See COPYING and COPYING.ja for further details.
