...
* MODIFIED: For the "TABLE" class and the "column" column, TABLE.find_by_column retrives a first record, and TABLE.find_all_by_column retrieves all the records as an Array.
