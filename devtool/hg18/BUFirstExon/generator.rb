...
HEADER = "      ## track: BU First Exon"

TABLES = %w(
encodeBuFirstExonCerebrum
encodeBuFirstExonColon
encodeBuFirstExonHeart
encodeBuFirstExonKidney
encodeBuFirstExonLiver
encodeBuFirstExonLung
encodeBuFirstExonSkMuscle
encodeBuFirstExonSpleen
encodeBuFirstExonStomach
encodeBuFirstExonTestis
)
