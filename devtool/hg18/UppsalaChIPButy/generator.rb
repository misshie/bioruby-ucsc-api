...
HEADER = "      ## track: Uppsala ChIP Buty"

TABLES = %w(
encodeUppsalaChipH3acBut0h
encodeUppsalaChipH3acBut12h
encodeUppsalaChipH4acBut0h
encodeUppsalaChipH4acBut12h
encodeUppsalaChipH3acBut0vs12
encodeUppsalaChipH4acBut0vs12
)
