...
HEADER = "      ## track: Yale RNA"

TABLES = %w(
encodeYaleAffyNeutRNATransMap
encodeYaleAffyPlacRNATransMap
encodeYaleAffyNB4RARNATransMap
encodeYaleAffyNB4TPARNATransMap
encodeYaleAffyNB4UntrRNATransMap
)
