...
HEADER = "      ## track: Yale STAT1 Sig"

TABLES = %w(
encodeYaleChIPSTAT1HeLaMaskLess36mer36bpSig
encodeYaleChIPSTAT1HeLaMaskLess50mer38bpSig
encodeYaleChIPSTAT1HeLaMaskLess50mer50bpSig
encodeYaleChIPSTAT1HeLaBingRenSig
)
