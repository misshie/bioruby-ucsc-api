...
HEADER = "      ## track: Yale STAT1 Sites"

TABLES = %w(
encodeYaleChIPSTAT1HeLaMaskLess36mer36bpSite
encodeYaleChIPSTAT1HeLaMaskLess50mer38bpSite
encodeYaleChIPSTAT1HeLaMaskLess50mer50bpSite
encodeYaleChIPSTAT1HeLaBingRenSites
)
