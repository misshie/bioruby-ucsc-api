# -*- coding: utf-8 -*-
# = hg19/burgernaseqgemmapperalignhmeallrawsignal.rb
# Copyright::
...
module Bio
  module Ucsc
    module Hg19
      class BurgeRnaSeqGemMapperAlignHMEAllRawSignal < DBConnection
        extend Bio::Ucsc::Hg19::QueryUsingChromBin
        set_table_name 'burgeRnaSeqGemMapperAlignHMEAllRawSignal'
        set_primary_key nil
      end 
    end # module Hg19
  end # module Ucsc
