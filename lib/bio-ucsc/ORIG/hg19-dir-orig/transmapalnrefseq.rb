...
# This track contains RefSeq Gene alignments produced by the TransMap
...
module Bio
  module Ucsc
    module Hg19
      class TransMapAlnRefSeq < DBConnection
        extend Bio::Ucsc::Hg19::QueryUsingTBin
        set_table_name 'transMapAlnRefSeq'
        set_primary_key nil
      end 
    end # module Hg19
  end # module Ucsc
