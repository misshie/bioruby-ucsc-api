# -*- coding: utf-8 -*-
# = hg19/wgencodeopenchromfairehelas3ifna4hpk.rb
# Copyright::
...
module Bio
  module Ucsc
    module Hg19
      class WgEncodeOpenChromFaireHelas3Ifna4hPk < DBConnection
        extend Bio::Ucsc::Hg19::QueryUsingChromBin
        set_table_name 'wgEncodeOpenChromFaireHelas3Ifna4hPk'
        set_primary_key nil
      end 
    end # module Hg19
  end # module Ucsc
