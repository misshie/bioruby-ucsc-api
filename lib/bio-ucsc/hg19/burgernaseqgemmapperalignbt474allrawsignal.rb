# -*- coding: utf-8 -*-
# = hg19/burgernaseqgemmapperalignbt474allrawsignal.rb
# Copyright::
...
module Bio
  module Ucsc
    module Hg19
      class BurgeRnaSeqGemMapperAlignBT474AllRawSignal < DBConnection
        extend Bio::Ucsc::Hg19::QueryUsingChromBin
        set_table_name 'burgeRnaSeqGemMapperAlignBT474AllRawSignal'
        set_primary_key nil
      end 
    end # module Hg19
  end # module Ucsc
