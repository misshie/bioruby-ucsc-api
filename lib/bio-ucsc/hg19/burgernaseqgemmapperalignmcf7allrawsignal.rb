# -*- coding: utf-8 -*-
# = hg19/burgernaseqgemmapperalignmcf7allrawsignal.rb
# Copyright::
...
module Bio
  module Ucsc
    module Hg19
      class BurgeRnaSeqGemMapperAlignMCF7AllRawSignal < DBConnection
        extend Bio::Ucsc::Hg19::QueryUsingChromBin
        set_table_name 'burgeRnaSeqGemMapperAlignMCF7AllRawSignal'
        set_primary_key nil
      end 
    end # module Hg19
  end # module Ucsc
