# -*- coding: utf-8 -*-
# = hg19/wgencodehaibmethylrrbsmelanositesrep3.rb
# Copyright::
...
module Bio
  module Ucsc
    module Hg19
      class WgEncodeHaibMethylRrbsMelanoSitesRep3 < DBConnection
        extend Bio::Ucsc::Hg19::QueryUsingChromBin
        set_table_name 'wgEncodeHaibMethylRrbsMelanoSitesRep3'
        set_primary_key nil
      end 
    end # module Hg19
  end # module Ucsc
