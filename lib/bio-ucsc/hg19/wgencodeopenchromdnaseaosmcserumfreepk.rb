# -*- coding: utf-8 -*-
# = hg19/wgencodeopenchromdnaseaosmcserumfreepk.rb
# Copyright::
...
module Bio
  module Ucsc
    module Hg19
      class WgEncodeOpenChromDnaseAosmcSerumfreePk < DBConnection
        extend Bio::Ucsc::Hg19::QueryUsingChromBin
        set_table_name 'wgEncodeOpenChromDnaseAosmcSerumfreePk'
        set_primary_key nil
      end 
    end # module Hg19
  end # module Ucsc
