# -*- coding: utf-8 -*-
# = hg19/wgencodeopenchromfairemcf7hypoxlacpk.rb
# Copyright::
...
module Bio
  module Ucsc
    module Hg19
      class WgEncodeOpenChromFaireMcf7HypoxlacPk < DBConnection
        extend Bio::Ucsc::Hg19::QueryUsingChromBin
        set_table_name 'wgEncodeOpenChromFaireMcf7HypoxlacPk'
        set_primary_key nil
      end 
    end # module Hg19
  end # module Ucsc
