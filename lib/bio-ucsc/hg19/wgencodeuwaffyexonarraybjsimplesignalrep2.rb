# -*- coding: utf-8 -*-
# = hg19/wgencodeuwaffyexonarraybjsimplesignalrep2.rb
# Copyright::
...
module Bio
  module Ucsc
    module Hg19
      class WgEncodeUwAffyExonArrayBjSimpleSignalRep2 < DBConnection
        extend Bio::Ucsc::Hg19::QueryUsingChromBin
        set_table_name 'wgEncodeUwAffyExonArrayBjSimpleSignalRep2'
        set_primary_key nil
      end 
    end # module Hg19
  end # module Ucsc
