# -*- coding: utf-8 -*-
# = hg19/wgencodeuwaffyexonarrayhgfsimplesignalrep2.rb
# Copyright::
...
module Bio
  module Ucsc
    module Hg19
      class WgEncodeUwAffyExonArrayHgfSimpleSignalRep2 < DBConnection
        extend Bio::Ucsc::Hg19::QueryUsingChromBin
        set_table_name 'wgEncodeUwAffyExonArrayHgfSimpleSignalRep2'
        set_primary_key nil
      end 
    end # module Hg19
  end # module Ucsc
