# -*- coding: utf-8 -*-
# = hg19/wgencodeuwaffyexonarrayhmfsimplesignalrep1.rb
# Copyright::
...
module Bio
  module Ucsc
    module Hg19
      class WgEncodeUwAffyExonArrayHmfSimpleSignalRep1 < DBConnection
        extend Bio::Ucsc::Hg19::QueryUsingChromBin
        set_table_name 'wgEncodeUwAffyExonArrayHmfSimpleSignalRep1'
        set_primary_key nil
      end 
    end # module Hg19
  end # module Ucsc
