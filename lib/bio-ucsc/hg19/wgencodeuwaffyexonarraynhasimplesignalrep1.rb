# -*- coding: utf-8 -*-
# = hg19/wgencodeuwaffyexonarraynhasimplesignalrep1.rb
# Copyright::
...
module Bio
  module Ucsc
    module Hg19
      class WgEncodeUwAffyExonArrayNhaSimpleSignalRep1 < DBConnection
        extend Bio::Ucsc::Hg19::QueryUsingChromBin
        set_table_name 'wgEncodeUwAffyExonArrayNhaSimpleSignalRep1'
        set_primary_key nil
      end 
    end # module Hg19
  end # module Ucsc
