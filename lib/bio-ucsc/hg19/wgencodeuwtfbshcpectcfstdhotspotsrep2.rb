# -*- coding: utf-8 -*-
# = hg19/wgencodeuwtfbshcpectcfstdhotspotsrep2.rb
# Copyright::
...
module Bio
  module Ucsc
    module Hg19
      class WgEncodeUwTfbsHcpeCtcfStdHotspotsRep2 < DBConnection
        extend Bio::Ucsc::Hg19::QueryUsingChromBin
        set_table_name 'wgEncodeUwTfbsHcpeCtcfStdHotspotsRep2'
        set_primary_key nil
      end 
    end # module Hg19
  end # module Ucsc
