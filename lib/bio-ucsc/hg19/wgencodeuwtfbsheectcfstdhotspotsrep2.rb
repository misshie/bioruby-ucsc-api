# -*- coding: utf-8 -*-
# = hg19/wgencodeuwtfbsheectcfstdhotspotsrep2.rb
# Copyright::
...
module Bio
  module Ucsc
    module Hg19
      class WgEncodeUwTfbsHeeCtcfStdHotspotsRep2 < DBConnection
        extend Bio::Ucsc::Hg19::QueryUsingChromBin
        set_table_name 'wgEncodeUwTfbsHeeCtcfStdHotspotsRep2'
        set_primary_key nil
      end 
    end # module Hg19
  end # module Ucsc
