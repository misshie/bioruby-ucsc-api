...
describe "Bio::Ucsc::AilMel1" do
  ...
  describe "Bio::Ucsc::AilMel1::ChainCanFam2" do
    context ".first" do
      it 'returns the first records' do
        result = Bio::Ucsc::AilMel1::ChainCanFam2.first
        pp result
        result.should be_true
      end
    end
  ...
  describe "Bio::Ucsc::AilMel1::ChainCanFam2Link" do
    context ".first" do
      it 'returns the first records' do
        result = Bio::Ucsc::AilMel1::ChainCanFam2Link.first
        pp result
        result.should be_true
      end
    end
  ...
  describe "Bio::Ucsc::AilMel1::ChainFelCat4" do
    context ".first" do
      it 'returns the first records' do
        result = Bio::Ucsc::AilMel1::ChainFelCat4.first
        pp result
        result.should be_true
      end
    end
  ...
  describe "Bio::Ucsc::AilMel1::ChainFelCat4Link" do
    context ".first" do
      it 'returns the first records' do
        result = Bio::Ucsc::AilMel1::ChainFelCat4Link.first
        pp result
        result.should be_true
      end
    end
  ...
  describe "Bio::Ucsc::AilMel1::ChainMonDom5" do
    context ".first" do
      it 'returns the first records' do
        result = Bio::Ucsc::AilMel1::ChainMonDom5.first
        pp result
        result.should be_true
      end
    end
  ...
  describe "Bio::Ucsc::AilMel1::ChainMonDom5Link" do
    context ".first" do
      it 'returns the first records' do
        result = Bio::Ucsc::AilMel1::ChainMonDom5Link.first
        pp result
        result.should be_true
      end
    end
  ...
  describe "Bio::Ucsc::AilMel1::ChainRn4" do
    context ".first" do
      it 'returns the first records' do
        result = Bio::Ucsc::AilMel1::ChainRn4.first
        pp result
        result.should be_true
      end
    end
  ...
  describe "Bio::Ucsc::AilMel1::ChainRn4Link" do
    context ".first" do
      it 'returns the first records' do
        result = Bio::Ucsc::AilMel1::ChainRn4Link.first
        pp result
        result.should be_true
      end
    end
  ...
  describe "Bio::Ucsc::AilMel1::EnsGene" do
    context ".first" do
      it 'returns the first records' do
        result = Bio::Ucsc::AilMel1::EnsGene.first
        pp result
        result.should be_true
      end
    end
  ...
  describe "Bio::Ucsc::AilMel1::EnsGtp" do
    context ".first" do
      it 'returns the first records' do
        result = Bio::Ucsc::AilMel1::EnsGtp.first
        pp result
        result.should be_true
      end
    end
  ...
  describe "Bio::Ucsc::AilMel1::EnsPep" do
    context ".first" do
      it 'returns the first records' do
        result = Bio::Ucsc::AilMel1::EnsPep.first
        pp result
        result.should be_true
      end
    end
  ...
  describe "Bio::Ucsc::AilMel1::NetCanFam2" do
    context ".first" do
      it 'returns the first records' do
        result = Bio::Ucsc::AilMel1::NetCanFam2.first
        pp result
        result.should be_true
      end
    end
  ...
  describe "Bio::Ucsc::AilMel1::NetFelCat4" do
    context ".first" do
      it 'returns the first records' do
        result = Bio::Ucsc::AilMel1::NetFelCat4.first
        pp result
        result.should be_true
      end
    end
  ...
  describe "Bio::Ucsc::AilMel1::NetMonDom5" do
    context ".first" do
      it 'returns the first records' do
        result = Bio::Ucsc::AilMel1::NetMonDom5.first
        pp result
        result.should be_true
      end
    end
  ...
  describe "Bio::Ucsc::AilMel1::NetRn4" do
    context ".first" do
      it 'returns the first records' do
        result = Bio::Ucsc::AilMel1::NetRn4.first
        pp result
        result.should be_true
      end
    end
  ...
  describe "Bio::Ucsc::AilMel1::Rmsk" do
    context ".first" do
      it 'returns the first records' do
        result = Bio::Ucsc::AilMel1::Rmsk.first
        pp result
        result.should be_true
      end
    end
