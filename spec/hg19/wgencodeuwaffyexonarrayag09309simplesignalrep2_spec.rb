  ...
  describe "#find_by_interval" do
    context "given range chr1:1-20,000" do
      it "returns an array of records" do
        ...
        r = Bio::Ucsc::Hg19::WgEncodeUwAffyExonArrayAg09309SimpleSignalRep2.find_all_by_interval(i)
      ...
      it 'returns a record (r.chrom == "chr1")' do
        ...
        Bio::Ucsc::Hg19::DBConnection.connect
        i = Bio::GenomicInterval.parse("chr1:1-20,000")
        r = Bio::Ucsc::Hg19::WgEncodeUwAffyExonArrayAg09309SimpleSignalRep2.find_by_interval(i)
        r.chrom.should == "chr1"
      end
    end
  end
