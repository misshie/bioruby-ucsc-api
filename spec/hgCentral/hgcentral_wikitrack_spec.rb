require 'bio-ucsc'
describe "Bio::Ucsc::Hg19::Hgcentral_WikiTrack" do 
  ...
  describe "#find_by_interval" do
    context "given range chr1:1-2,000,000" do
      it "returns an array of results" do
        ...
        r = Bio::Ucsc::Hg19::Hgcentral_WikiTrack.find_all_by_interval(i)
      ...
      it 'returns (r.chrom == "chr1")' do
        ...
        r = Bio::Ucsc::Hg19::Hgcentral_WikiTrack.find_by_interval(i)
        r.chrom.should == "chr1"
      end
    end
  end
