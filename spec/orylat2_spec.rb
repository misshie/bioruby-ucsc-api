...
describe "Bio::Ucsc::OryLat2" do
  ...
  describe "Bio::Ucsc::OryLat2::ChainFr3" do
    context ".first" do
      it 'returns the first records' do
        result = Bio::Ucsc::OryLat2::ChainFr3.first
        pp result
        result.should be_true
      end
    end
  ...
  describe "Bio::Ucsc::OryLat2::ChainFr3Link" do
    context ".first" do
      it 'returns the first records' do
        result = Bio::Ucsc::OryLat2::ChainFr3Link.first
        pp result
        result.should be_true
      end
    end
  ...
  describe "Bio::Ucsc::OryLat2::ChainPetMar2" do
    context ".first" do
      it 'returns the first records' do
        result = Bio::Ucsc::OryLat2::ChainPetMar2.first
        pp result
        result.should be_true
      end
    end
  ...
  describe "Bio::Ucsc::OryLat2::ChainPetMar2Link" do
    context ".first" do
      it 'returns the first records' do
        result = Bio::Ucsc::OryLat2::ChainPetMar2Link.first
        pp result
        result.should be_true
      end
    end
  ...
  describe "Bio::Ucsc::OryLat2::NetFr3" do
    context ".first" do
      it 'returns the first records' do
        result = Bio::Ucsc::OryLat2::NetFr3.first
        pp result
        result.should be_true
      end
    end
  ...
  describe "Bio::Ucsc::OryLat2::NetPetMar2" do
    context ".first" do
      it 'returns the first records' do
        result = Bio::Ucsc::OryLat2::NetPetMar2.first
        pp result
        result.should be_true
      end
    end
