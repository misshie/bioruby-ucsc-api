describe "Bio::Ucsc::Rn5" do
  ...
  describe "Bio::Ucsc::Rn5::ChainMm10" do
    context ".find_by_interval" do
      it 'returns the first records' do
        gi = Bio::GenomicInterval.parse("chrX:1-1,000,000")
        result = Bio::Ucsc::Rn5::ChainMm10.find_by_interval gi
        pp result
        result.should be_true
      end
    end
  ...
  describe "Bio::Ucsc::Rn5::ChainMm10Link" do
    context ".find_by_interval" do
      it 'returns the first records' do
        gi = Bio::GenomicInterval.parse("chrX:1-1,000,000")
        result = Bio::Ucsc::Rn5::ChainMm10Link.find_by_interval gi
        pp result
        result.should be_true
      end
    end
  ...
  describe "Bio::Ucsc::Rn5::ChainRheMac3" do
    context ".find_by_interval" do
      it 'returns the first records' do
        gi = Bio::GenomicInterval.parse("chrX:1-1,000,000")
        result = Bio::Ucsc::Rn5::ChainRheMac3.find_by_interval gi
        pp result
        result.should be_true
      end
    end
  ...
  describe "Bio::Ucsc::Rn5::ChainRheMac3Link" do
    context ".find_by_interval" do
      it 'returns the first records' do
        gi = Bio::GenomicInterval.parse("chrX:1-1,000,000")
        result = Bio::Ucsc::Rn5::ChainRheMac3Link.find_by_interval gi
        pp result
        result.should be_true
      end
    end
  ...
  describe "Bio::Ucsc::Rn5::GenscanSubopt" do
    context ".first" do
      it 'returns the first records' do
        result = Bio::Ucsc::Rn5::GenscanSubopt.first
        pp result
        result.should be_true
      end
    end
  ...
  describe "Bio::Ucsc::Rn5::NetMm10" do
    context ".first" do
      it 'returns the first records' do
        result = Bio::Ucsc::Rn5::NetMm10.first
        pp result
        result.should be_true
      end
    end
  ...
  describe "Bio::Ucsc::Rn5::NetRheMac3" do
    context ".first" do
      it 'returns the first records' do
        result = Bio::Ucsc::Rn5::NetRheMac3.first
        pp result
        result.should be_true
      end
    end
